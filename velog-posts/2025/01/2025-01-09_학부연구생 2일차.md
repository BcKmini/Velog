...
source: "https://velog.io/@mi_nini/%ED%95%99%EB%B6%80%EC%97%B0%EA%B5%AC%EC%83%9D-2%EC%9D%BC%EC%B0%A8"
---
...
FastAPI는 OpenAPI와 JSON Schema를 기반으로 
자동 API 문서화
를 제공합니다.
...
/
await
 문법을 기본적으로 지원하여 비동기 작업을 간단하게 구현 가능.
...
Html, js, css를 이용해서 틀을 만들어주고 fastapi를 이용해서  
http://127.0.0.1:8000/
 로컬서버에 돌린 결과이다. 우리는 결과적으로 React와 fastapi를 연결하는 것이 중요하기에 이부분을 중심적으로 다시 공부해보고 연결해봐야 하겠다. 
