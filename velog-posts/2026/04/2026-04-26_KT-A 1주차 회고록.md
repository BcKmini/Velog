...
### 1주차
&gt; 자기소개/인사말
![자기소개](https://velog.velcdn.com/images/mi_nini/post/9891354f-654e-4118-8ad9-65646cb88cbc/image.png)

간단하게 입교식 및 AIVLE-EDU 사용법에 대해 매니저님께서 설명해 주셨다. 수업내용과 자료는 사이트에서 다운로드해 활용하고 [Teams](https://www.microsoft.com/ko-kr/microsoft-teams/download-app)를 이용해 5,6반 에의 블러 팀원들과 매니저님과 소통할 수 있게 되었다.  1주 차여서 깃허브 사용법과 Colab-Python 데이터 전처리를 간단하게 배웠다. 복습을 해보자 (깃 README.md에 정리된 내용) 
...
## 생각정리
깃허브를 배우는 수업에서 [VScode-Git-graph](https://github.com/mhutchie/vscode-git-graph) 이용법에 대해 배웠던 점이 인상 깊었다. 항상 터미널로 작업하던 입장으로써 눈으로 직관적으로 brnach들을 볼 수 있다는 점 그리고 간단하게 클릭으로 Checkout, Merge, Rebase, Reset, Revert 등 확인하다는 점이다. 유용하게 프로젝트를 진행할 때 사용할 거 같았다. (코드 리뷰할 때도 편할 거 같았다)

![](https://velog.velcdn.com/images/mi_nini/post/8e15f35e-0208-459c-aef5-1874c37f725f/image.png)

데이터 전처리 코드를 수없이 봐왔던거 같다(캐글, 자격증 준비, 전공) 이번 1주차에서는 기본적인 내용으로 짧고 빠르게 많은 함수에 사용법을 알아가는 시간이었던 거 같다. 수업 시간이 09~18시까지 온라인으로 이어지다 보니 아침에 일어나 적응하는 시간이 아직 익숙해지지 않았던 거 같다. 날마다 체크인과 체크아웃 시간에 자기소개 시간을 가지며 같은 반 에이블러님들이  어떤 목표로 부트 캠프에 참여하게 된 걸 알게 되어 좋았던 거 같다. (같은 목표를 바라보는 에이블러님들이 많았던 거 같다) 자기소개 이외에 교육을 진행하는 동안 840시간의 여정에 나에게 보내는 미래 편지를 작성하는 시간이 있었다. 그 말을 이룰 수 있도록 부끄럽지 않게 열심히 임해 후회 없는 시간들을 보냈으면 좋겠다고 생각하며 1주 차를 마무리한다.
...
---
#### [Github-Private](https://github.com/KT-E/01-Week)
