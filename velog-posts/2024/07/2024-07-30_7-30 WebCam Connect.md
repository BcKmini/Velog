...
코렙 서버에서는 cv2가 지원이 되지 않아 내장으로 있는 캠이 인식을 못하는 상황이 발생했다... 죽고싶다.. 모델훈련했던 pt파일을 노트북 로컬에서 한버 돌려봐야겠다.. 제일 문제는 내가 원래 계획했던 카메라or캠orCCTV가 인식을 하고 위험감지를 핸드폰에 메시지로 보내는 코드를 작성하려고 했다. 이것을 찾아 보니 
Firebase
라는 좋은 소스가 있었다. 
...
"극도의 위험! 즉시 대피하세요! 압사 위험이 매우 높습니다."
,
...
"심각한 위험! 군중 밀집도가 매우 높습니다. 즉시 주의하세요!"
,
