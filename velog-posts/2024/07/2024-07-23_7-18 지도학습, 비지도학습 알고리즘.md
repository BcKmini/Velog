...
주성분분석(PCA) 이해, 구현 및 실습


t-SNE를 이용한 매니폴드 학습 이해 및 실습
...
집합 D의 각 데이터에 대해 k개의 클러스터 중심과의 거리를 계산하고, 각 데이터가 어
...
클러스터의 중심점을 다시 계산한다. 즉, 2에서 재할당된 클러스터들을 기준으로 중심점
